...
export const PROVIDERS = {
  ...
  selcom: { module: selcom, label: "Selcom (mobile money + Visa/Mastercard)", verified: true },
};
...
// company by default. Selcom is deliberately offered as its own
// separate mobile money choice too, alongside M-Pesa, Mixx by Yas,
// and Airtel Money directly — confirmed directly, not assumed: this
// is a genuine fifth option a tenant can pick, not Selcom quietly
// standing in for the others. Selcom remains the only option for
// Visa/Mastercard specifically, since card acceptance needs a hosted
// checkout page and Selcom is the one confirmed available here.
