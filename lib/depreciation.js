...
export function calculateCurrentValue({ acquisitionCost, residualValue, economicLifeYears, acquisitionDate, asOfDate }) {
  ...
  // Confirmed directly: real historical snapshots (Annual/Monthly
  // reports) need book value AS OF a specific past date, not always
  // today - defaults to today so every existing caller keeps behaving
  // exactly as before.
