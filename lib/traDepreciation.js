...
export function calculateTRAValue({ acquisitionCost, acquisitionDate, rate, asOfDate }) {
  ...
  // Confirmed directly, matching the exact same real change already
  // proven for straight-line - defaults to today so every existing
